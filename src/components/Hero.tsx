...
export function Hero() {
  ...
  return (
    <section className="relative pt-32 pb-16 flex md:pt-40 md:pb-24 overflow-hidden h-screen ">
      ...
      {/* Custom Cursor */}
      <div
        className={`absolute rounded-full w-12 h-12 bg-primary transition-all duration-200 transform -translate-x-1/2 -translate-y-1/2 pointer-events-none ${
